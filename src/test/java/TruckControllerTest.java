...
import static org.example.communication.UpsServer.userMapper;
...
//        userMapper1.insertUser(new User("10", "222"));
//        sqlSession.commit();
        WorldUps.UTruck.Builder builder = WorldUps.UTruck.newBuilder();
        builder.setSeqnum(1).setTruckid(0).setX(4).setY(4).setStatus("status");
        ACommandHandler aCommandHandler = new ACommandHandler();
        WCommandHandler wCommandHandler = new WCommandHandler();

        wCommandHandler.handleUTruck(builder.build());
